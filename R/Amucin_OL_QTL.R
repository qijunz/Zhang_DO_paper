...
# cecal_m <- readRDS(paste0(data.dir, "mediation_metagene2cecumMetabolite_LOD_drop_tbl.rds"))
# liver_l <- readRDS(paste0(data.dir, "mediation_metagene2liverLipid_LOD_drop_tbl.rds"))
# liver_m <- readRDS(paste0(data.dir, "mediation_metagene2liverMetabolite_LOD_drop_tbl.rds"))
# plasma_l <- readRDS(paste0(data.dir, "mediation_metagene2plasmaLipid_LOD_drop_tbl.rds"))
# plasma_m <- readRDS(paste0(data.dir, "mediation_metagene2plasmaMetabolite_LOD_drop_tbl.rds"))

cecal_l$lod.drop.prec <- cecal_l$lod.drop/cecal_l$lod.org*100
# cecal_m$lod.drop.prec <- cecal_m$lod.drop/cecal_m$lod.org*100
# liver_l$lod.drop.prec <- liver_l$lod.drop/liver_l$lod.org*100
# liver_m$lod.drop.prec <- liver_m$lod.drop/liver_m$lod.org*100
# plasma_l$lod.drop.prec <- plasma_l$lod.drop/plasma_l$lod.org*100
# plasma_m$lod.drop.prec <- plasma_m$lod.drop/plasma_m$lod.org*100
